...
MAXERRORESSCJN = int(os.getenv("MAX_ERRORES_SCJN", "5"))
ESPERAPAUSASCJN = int(os.getenv("ESPERA_PAUSA_SCJN", str(20 * 60)))  # 20 min
...
SEEDCOLATESIS = os.getenv("SEED_TESIS_COLA", "0").strip()  # "1" para sembrar, "0" para NO

# Vectorización por rango de años (opcional)
VECTORRANGO = os.getenv("VECTOR_SOLO_RANGO", "0").strip()  # "1" = solo si anio en rango; "0" = vectoriza todo
