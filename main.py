...
BLOQUES = [
    ...
    # Saltamos 160000–161000 porque ya lo tienes

    (161000, 206000),   # Rango intermedio que faltaba

    # Saltamos 206000–207000 porque ya lo tienes

    (207000, 2023000),  # Todo lo que falta hasta el siguiente bloque ya procesado

    # Saltamos 2023000–2028000 porque ya lo tienes

    (2028000, 2031780), # Último tramo hasta el final del acervo
]
